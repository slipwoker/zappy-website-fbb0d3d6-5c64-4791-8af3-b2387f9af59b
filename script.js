document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormError(message) {
      let errorEl = contactForm.querySelector('.form-global-error');
      if (!errorEl) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fbb0d3d6-5c64-4791-8af3-b2387f9af59b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fbb0d3d6-5c64-4791-8af3-b2387f9af59b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fbb0d3d6-5c64-4791-8af3-b2387f9af59b';
